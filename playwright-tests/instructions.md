...
- **After changes**: run `pnpm run typecheck` and a targeted test:
...
3. Run targeted tests (`pnpm run typecheck`, plus a relevant test command).
4. Run `/review <scope>` for quality and security.
